...
proptest! {
    ...
    #[test]
    fn from_i420_succeeds_with_even_nonzero_and_matching_plane_lengths(
    ...
    #[test]
    fn from_i420_rejects_odd_dimensions(
    ...
    #[test]
    fn from_i420_returns_error_on_plane_length_mismatch(
